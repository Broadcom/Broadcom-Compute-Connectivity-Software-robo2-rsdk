...
/*
 * For linux, the readline library is not available in the tool chain. Will disable this
 * temorarily for external host.
 */
...
#define CINT_CONFIG_SPRINTF_BUFFER_LENGTH 128
#endif
...
#define CINT_CONFIG_INCLUDE_SDK_SAL 1
#endif
