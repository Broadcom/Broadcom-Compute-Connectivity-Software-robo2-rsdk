/*
 * $Id: cint_datatypes.c,v 1.26 2012/09/26 20:47:33 noahm Exp $
 * 
...
{
    static char _rstr[256];
    char _pstr[CINT_CONFIG_MAX_STACK_PRINT_BUFFER]; 
    char _astr[CINT_CONFIG_MAX_STACK_PRINT_BUFFER]; 
    int i; 
    int position;
    char* p; 

    sal_memset(_rstr, 0, sizeof(_rstr));
    sal_memset(_pstr, 0, sizeof(_pstr));
    sal_memset(_astr, 0, sizeof(_astr));
