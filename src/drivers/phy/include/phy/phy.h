...
/* Speed out of pht ability setting
 * the list is sync with sdk SOC_PA_SPEED_*
 */
#define SOC_PA_SPEED_2500MB       (1L << 7)
#define SOC_PA_SPEED_5000MB       (1L << 9)
...
#define PHY_REG_READ(_pc, _c, _v) \
		((_pc) == NULL ? CDK_E_INTERNAL: (_pc)->drv == NULL ? CDK_E_INIT : \
