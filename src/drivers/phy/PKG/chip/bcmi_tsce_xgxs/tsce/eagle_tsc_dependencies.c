...
err_code_t eagle_tsc_pmd_mwr_reg_addr32(const phymod_access_t *pa, uint32_t address, uint16_t mask, uint8_t lsb, uint16_t val) {
...
err_code_t eagle_tsc_pmd_rdt_reg_addr32(const phymod_access_t *pa, uint32_t address, uint16_t *val) {
    uint32_t data;
