/*
 * $Id: types.h,v 1.33 2012/08/02 13:59:19 gili Exp $
 * 
...
typedef int /* FIXME should be _shr_gport_t once bcm_gport_t is also typedefed from it */   soc_gport_t;
 ...
 */
/* FIXME should be: typedef _shr_multicast_replication_t soc_multicast_replication_t; once {soc,bcm}_gport_t are typedefed to _shr_gport_t */
